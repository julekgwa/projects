...
import { n as createMiddleware, t as createCsrfMiddleware } from "./createCsrfMiddleware-DYp2MVKY.js";
import { n as __toESM, t as __commonJSMin } from "./chunk-B-1-B7_t-KGrUNz1V.js";
import { n as slugsToMarkdownPath } from "./source-nBqQHYFW.js";
import { r as docsRoute } from "./shared-DqE0m7Bq.js";
...
//#endregion
//#region node_modules/fumadocs-core/dist/negotiation-C6hn0LRz.js
/**
* negotiator
...
var llmMiddleware = createMiddleware().server(({ next, request }) => {
	const url = new URL(request.url);
	if (url.pathname.startsWith("/docs") && !url.pathname.endsWith(".md") && isMarkdownPreferred(request)) {
		url.pathname = slugsToMarkdownPath(url.pathname.slice(docsRoute.length).split("/").filter((v) => v.length > 0)).url;
		throw redirect(url);
	}
	return next();
});
var startInstance = createStart(() => {
	return { requestMiddleware: [llmMiddleware, csrfMiddleware] };
});
//#endregion
