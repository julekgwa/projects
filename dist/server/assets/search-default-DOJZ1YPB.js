...
import { a as visit, n as VFile, o as zwitch, r as VFileMessage, s as asciiAlphanumeric, t as remark } from "./remark-DooaQL_3.js";
import { S as I18nLabel, T as useTranslations, _ as useComposedRefs, a as Portal, b as cva, d as useControllableState, f as useId, g as composeRefs, h as createContextScope, i as Presence, j as useRouter, l as Primitive, m as createContext2, n as ReactRemoveScroll, o as FocusScope, r as useFocusGuards, s as DismissableLayer, t as hideOthers, v as composeEventHandlers, w as useI18n, x as twMerge, y as buttonVariants } from "./es2015-B4SUp18r.js";
...
import { n as useOnChange, t as e } from "./dist-DE_1wuj-.js";
...
function useDocsSearch(clientOptions, deps) {
	...
	if ("type" in clientRest) switch (clientRest.type) {
		case "fetch": {
			const { fetchClient } = (0, import_react.use)(promiseMap[clientRest.type] ??= import("./fetch-DgwgTV9I.js"));
			client = fetchClient(clientRest);
			break;
		}
		case "algolia": {
			const { algoliaClient } = (0, import_react.use)(promiseMap[clientRest.type] ??= import("./algolia-CnuuLCyX.js"));
			client = algoliaClient(clientRest);
			break;
		}
		case "orama-cloud": {
			const { oramaCloudClient } = (0, import_react.use)(promiseMap[clientRest.type] ??= import("./orama-cloud-CZs0IYHj.js"));
			client = oramaCloudClient(clientRest);
			break;
		}
		case "orama-cloud-legacy": {
			const { oramaCloudLegacyClient } = (0, import_react.use)(promiseMap[clientRest.type] ??= import("./orama-cloud-legacy-uTanpJne.js"));
			client = oramaCloudLegacyClient(clientRest);
			break;
		}
		case "mixedbread": {
			const { mixedbreadClient } = (0, import_react.use)(promiseMap[clientRest.type] ??= import("./mixedbread-CdiqOX15.js"));
			client = mixedbreadClient(clientRest);
			break;
		}
		case "static": {
			const { oramaStaticClient } = (0, import_react.use)(promiseMap[clientRest.type] ??= import("./orama-static-DfbIO8mq.js"));
