...
import { B as useForwardedRef, M as hasKeys, N as isDangerousProtocol, O as deepEqual$1, V as useIntersectionObserver, a as useHydrated, c as exactPathTest, d as removeTrailingSlash, j as functionalUpdate, n as useRouter, t as useStore } from "./useStore-QaLyuWZ_.js";
import { t as require_jsx_runtime } from "./jsx-runtime-BtDrtBkJ.js";
import { t as require_react_dom } from "./react-dom-D7jcyvM6.js";
import { A as usePathname, T as useTranslations, _ as useComposedRefs, a as Portal$1, b as cva, c as useCallbackRef, d as useControllableState, f as useId, g as composeRefs, h as createContextScope, i as Presence, k as Link$2, l as Primitive, n as ReactRemoveScroll, o as FocusScope, p as useLayoutEffect2, r as useFocusGuards, s as DismissableLayer, t as hideOthers, v as composeEventHandlers, w as useI18n, x as twMerge, y as buttonVariants } from "./es2015-B4SUp18r.js";
import { t as Search } from "./search-DmwepcW5.js";
import { i as packageGitConfig, l as Sun, p as Airplay, s as findPath, t as appName, u as Moon } from "./shared-DqE0m7Bq.js";
...
*/
var Link$1 = import_react.forwardRef((props, ref) => {
...
function ThemeSwitch({ className, mode = "light-dark", ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		"data-theme-toggle": "",
		...props,
		children: full.map(([key, Icon, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			"aria-label": t[label],
			className: twMerge(itemVariants({ active: value === key })),
...
function baseOptions(packageName) {
	const config = packageName ? packageGitConfig[packageName] : void 0;
	return {
		nav: { title: appName },
		githubUrl: config ? `https://github.com/${config.owner}/${config.repo}` : void 0
	};
}
//#endregion
export { useDirection as _, isLayoutTabActive as a, Link$1 as b, LinkItem as c, SearchTrigger as d, Popover as f, DirectionProvider as g, isActive as h, getLayoutTabs as i, baseSlots as l, PopoverTrigger as m, createCollection as n, isLinkItemActive as o, PopoverContent as p, useIsScrollTop as r, useLinkItems as s, baseOptions as t, Link as u, J as v, SearchProvider as y };
